...
VitaIME::VitaIME(){
	...
	//sceAppUtilInit(&(SceAppUtilInitParam){}, &(SceAppUtilBootParam){});
	//SceCommonDialogConfigParam sceDialogParam;
	//sceCommonDialogConfigParamInit(&sceDialogParam);
	//sceCommonDialogSetConfigParam(&sceDialogParam);
